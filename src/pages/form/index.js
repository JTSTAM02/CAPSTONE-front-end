...
const QAForm = () => {
  ...
  //------------------------Adds Data to Backend Watchlist and Movies Table------------------------
    ...
    <div className='container-fluid' style={{
      ...
      <div className='row'>
        <div className='col-lg-12'>
          ...
          {showRandomMovie ? (
            <div className="movie-info text-center" style={{ border: '20px solid #1F5D57', padding: '20px', borderRadius: '10px', backgroundColor: 'white', color: 'black', maxWidth: '800px' }}>
              <br></br>
              <h1 style={{color: '#CBB26A'}}>Your Random Movie Is:</h1>
            ...
            <div className='text-center genre-container'>
              ...
              {currentQuestion === 0 && (
                <div className="image-buttons m-5 d-flex justify-content-center flex-wrap">
                  <img
